...
/* Header for class com_liuwei_audiodemo_OpenGLPlayActivity */

#ifndef _Included_com_liuwei_audiodemo_OpenGLPlayActivity
#define _Included_com_liuwei_audiodemo_OpenGLPlayActivity
#ifdef __cplusplus
extern "C" {
#endif
...
void pcmCallBack(SLAndroidSimpleBufferQueueItf bf, void *contex) {
    ...
    if (!fp) {
        fp = fopen("/sdcard/1547188253894.pcm", "rb");
        LOGE("fp failed 1 ");
    }
    if (!fp) {
        LOGE("fp failed 2 ");
